...
pair = {"4" => {"2" => "P", "3" => "P", "4" => "P", "5" => "P", "6" => "P", "7" => "P", "8" => "H", "9" => "H", "10" => "H", "11" => "H"},
        "6" => {"2" => "P", "3" => "P", "4" => "P", "5" => "P", "6" => "P", "7" => "P", "8" => "P", "9" => "H", "10" => "H", "11" => "H"},
        "8" => {"2" => "H", "3" => "H", "4" => "P", "5" => "P", "6" => "P", "7" => "H", "8" => "H", "9" => "H", "10" => "H", "11" => "H"},
        "10" => {"2" => "Dh", "3" => "Dh", "4" => "Dh", "5" => "Dh", "6" => "Dh", "7" => "Dh", "8" => "Dh", "9" => "Dh", "10" => "H", "11" => "H"},
        "12" => {"2" => "P", "3" => "P", "4" => "P", "5" => "P", "6" => "P", "7" => "P", "8" => "H", "9" => "H", "10" => "H", "11" => "H"},
        "14" => {"2" => "P", "3" => "P", "4" => "P", "5" => "P", "6" => "P", "7" => "P", "8" => "P", "9" => "H", "10" => "S", "11" => "H"},
        "16" => {"2" => "P", "3" => "P", "4" => "P", "5" => "P", "6" => "P", "7" => "P", "8" => "P", "9" => "P", "10" => "P", "11" => "P"},
        "18" => {"2" => "P", "3" => "P", "4" => "P", "5" => "P", "6" => "P", "7" => "S", "8" => "P", "9" => "P", "10" => "S", "11" => "S"},
        "20" => {"2" => "S", "3" => "S", "4" => "S", "5" => "S", "6" => "S", "7" => "S", "8" => "S", "9" => "S", "10" => "S", "11" => "S"},
        "22" => {"2" => "P", "3" => "P", "4" => "P", "5" => "P", "6" => "P", "7" => "P", "8" => "P", "9" => "P", "10" => "P", "11" => "P"}}
...
puts "Player's Hand: #{card1}, #{card2}"
puts "Dealer's Card: #{dealer_card}"
puts
